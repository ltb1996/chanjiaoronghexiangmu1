<template>
    <div class="login-container">
        <video id="v1" autoplay muted loop class="background-video">
            <source src="../../assets/syxyjianyao.mp4" />
        </video>
        ...
        <form class="login-form" @submit.prevent="registerToLogin">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" placeholder="设置6至20位密码" v-model="state.passwordone" required />
            </div>
            <div class="form-group">
                <label for="password">确认密码</label>
                <input type="password" id="password" placeholder="请再次输入上面的密码" v-model="state.passwordtwo" required />
            </div>
...
.login-title {
    ...
    color: #fff;
    z-index: 99;
    background: url(../../assets/logobaisyxy.png) center center no-repeat;
    background-size: 30%;
    width: 1030px;
    height: 100px;
    display: flex;
